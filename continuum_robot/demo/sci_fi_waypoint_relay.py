...
# Default waypoint count is 18: matches the preset list length. More
# waypoints in weirder places = a busier, more dynamic "weird video".
DEFAULT_WAYPOINT_COUNT = 18
