...
def build_app_context(*, session_log_path: Path | None = None) -> AppContext:
    ...
    safety_guard = SafetyGuard(
        ...
        current_warning_ma=settings.safety.current_warning_ma,
        ...
        current_spike_cooldown_s=settings.safety.current_spike_cooldown_s,
        current_spike_return_to_previous_safe_goal=settings.safety.current_spike_return_to_previous_safe_goal,
        current_spike_max_events_per_servo=settings.safety.current_spike_max_events_per_servo,
