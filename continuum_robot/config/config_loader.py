...
class ConfigLoader:
    ...
    def load_settings(self) -> Settings:
        ...
        serial = SerialConfig(
            ...
            tracker_fallback_backend=self._maybe_path(system_data.get("tracker_fallback_backend")),
            tracker_fallback_enabled=bool(system_data.get("tracker_fallback_enabled", False)),
